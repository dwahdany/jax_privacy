...
class DataInputs:
    ...
    def from_dict(
        ...
        metadata = {k: v for k, v in data_dict.items() if k not in ("image", "label")}
        return cls(
        ...
        *,
        ...
        if is_training and augmult_config is not None:
            ...
            if use_tf:
                ...
                raise NotImplementedError("Augmult requires TensorFlow (for now).")
        elif is_training:
